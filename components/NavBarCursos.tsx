...
const NavBarCursos: NextPage<NavBarCursos> = ({children,category,name_teacher})=>{
  ...
  return(
    ...
    <div className="mx-auto py-10">
      <h1 className="text-2xl font-bold mb-10 cursor-pointer text-[#EC5252] duration-150">{category[1]}</h1>
      <ul>
        <li className="flex space-x-2 mt-10 cursor-pointer hover:text-[#EC5252] duration-150">
          <Link href={{
              pathname: url
          }}>
            <a><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
